use peisar_ast::{
    Document,
    tokens::token::{Block, Inline, Table},
};
...
pub fn visit_document_mut<V: AstVisitor + ?Sized>(doc: &mut Document, visitor: &mut V) {
...
fn visit_table<V: AstVisitor + ?Sized>(table: &mut Table, visitor: &mut V) {
